    ...
    <div className="portfolio">
      ...
      <img
        ...
        <div style={{float: `left`}}><ScrollAnimation duration={2}
            animateIn="bounceInLeft"><div style={{fontSize: `35px`, fontFamily:`'Great Vibes', cursive`, color: `white`}}>Upload & Feature<br/> your memories</div>
...
<div  onClick={() => {setOpen(!open); }} style={{transform: `rotate(270deg) translate(-40px, 130px)`, color:`white`, fontFamily: `'Righteous', cursive`}}>UPLOAD</div>
            </div>
    ...
    <ScrollAnimation
            ...
            animateIn="bounceInLeft">
              <div style={{fontFamily: `'Abril Fatface', cursive`, fontSize: `80px`, marginBottom: `70px`, marginLeft: `300px`}}>studio</div>
              </ScrollAnimation>

...
const Uploader = styled.div`
  ...
  margin-left: 260px;
  margin-top: 50px;
  background-color: rgba(31, 153, 147, 0.6);
  width: ${({ open }) => (open ? "350px" : "0px")};
`;
...
background-color: rgba(22, 128, 103, 0.4);
...
const ProtectedRoute = (props) => {
  ...
  const [imagesFeature, setImagesFeature] = useState({});
  ...
  const handleUploadFeature=(event)=>{
    console.log(event.target.files[0]);
    setImagesFeature(event.target.files[0]);
  };

  const uploadFeature=()=>{
    const form = new FormData();
    form.append('image', imagesFeature);
    console.log('uploaded');
    Axios.post('http://localhost:5000/feature',form, {
      onUploadProgress: progressEvent => {
        console.log('Upload Progress: ' + Math.round(progressEvent.loaded/progressEvent.total *100) + '%')
      }
    }).then((response)=>{
  ...
  if(props.loggedIn === 'logout') {
    ...
    <div className="portfolio">
      ...
      <img
        ...
        <div style={{float: `left`}}><ScrollAnimation duration={2}
            animateIn="bounceInLeft"><div style={{fontSize: `35px`, fontFamily:`'Great Vibes', cursive`, color: `white`}}>Store & Feature<br/> your memories</div>
            <div style={{height: `3px`, width: `100px`, borderRadius: `100px`, backgroundColor:`white`, marginTop:`10px`}}></div></ScrollAnimation>
            <ScrollAnimation duration={2.6}
            animateIn="bounceInLeft"><div style={{height: `3px`, width: `100px`, borderRadius: `100px`, backgroundColor:`white`, marginLeft: `60px`, marginTop: `10px`}}></div></ScrollAnimation>
            <div onClick={() => {setOpen(!open); }} style={{transform: `rotate(270deg) translate(-5px, 130px)`, color:`white`}}><svg height="30px" width="38px" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cloud-upload-alt" className="svg-inline--fa fa-cloud-upload-alt fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path fill="white" d="M537.6 226.6c4.1-10.7 6.4-22.4 6.4-34.6 0-53-43-96-96-96-19.7 0-38.1 6-53.3 16.2C367 64.2 315.3 32 256 32c-88.4 0-160 71.6-160 160 0 2.7.1 5.4.2 8.1C40.2 219.8 0 273.2 0 336c0 79.5 64.5 144 144 144h368c70.7 0 128-57.3 128-128 0-61.9-44-113.6-102.4-125.4zM393.4 288H328v112c0 8.8-7.2 16-16 16h-48c-8.8 0-16-7.2-16-16V288h-65.4c-14.3 0-21.4-17.2-11.3-27.3l105.4-105.4c6.2-6.2 16.4-6.2 22.6 0l105.4 105.4c10.1 10.1 2.9 27.3-11.3 27.3z"></path></svg></div>

           

<div  onClick={() => {setOpen(!open); setFeature(false); setStore(false); }} style={{transform: `rotate(270deg) translate(-40px, 130px)`, color:`white`, fontFamily: `'Righteous', cursive`}}>UPLOAD</div>
            </div>
           ...
           <Uploader open={open}>
             ...
             <div style={{float: `left`, marginLeft: `260px`,transform: `translate(354px, -240px)`, textAlign: `center`}}>
              
             <Store open={store}>
               <br/>
             <span style={{ fontSize: `30px`,fontFamily: `"Righteous", cursive`, color: `white`}}>Store<br/>Memories</span><br/>
            <input type="file" name="file" style={{color: `white`, backgroundColor: `teal`, margin: `30px`, boxShadow: `0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 10px 0 rgba(0, 0, 0, 0.10)`}} onChange={handleUpload}/>
            <p style={{color: `white`}}>{msg1}</p>
            <button onClick={upload} style={{borderRadius: `5px`, backgroundColor: `#6f2d75`, color: `white` , padding: `9.5px 20px`,boxShadow: `0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)`, border: `none`, fontSize:`16px`, fontFamily: `'Righteous', cursive`}}>upload</button>
            <br/>
            <br/>
            <br/>
            </Store>
            ...
            <br/>
            <span style={{ fontSize: `30px`,fontFamily: `"Righteous", cursive`, color: `white`}}>Feature <br/> Stories</span>
            <input type="file" name="file" style={{color: `white`, backgroundColor: `teal`, margin: `30px`, boxShadow: `0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 10px 0 rgba(0, 0, 0, 0.10)`}} onChange={handleUploadFeature}/>
           <p style={{color: `white`}}>{msg2}</p>
            <button onClick={uploadFeature} style={{borderRadius: `5px`, backgroundColor: `#6f2d75`, color: `white` , padding: `9.5px 20px`,boxShadow: `0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)`, border: `none`, fontSize:`16px`, fontFamily: `'Righteous', cursive`}}>upload</button>
            <br/>
            <br/>
            <br/>
            </Feature>
    ...
    <ScrollAnimation
            ...
            animateIn="bounceInLeft">
              <div style={{transform: `translate(-400px, 0px)`,fontFamily: `'Abril Fatface', cursive`, fontSize: `80px`, marginBottom: `70px`, marginLeft: `100px`}}>studio</div>
              </ScrollAnimation>
    ...
    <div style={{paddingTop: `100px`}}>
              ...
              <div style={{fontFamily: `'Great Vibes', cursive`, fontSize: `80px`, marginBottom: `70px`, textAlign: `center`}}>Collection</div>
             
      <ul className="image-viewer1">
          {photos.map((photo) => (
            <li
              key={photo}
              style={{
  ...
  useEffect(() => {
    Axios.get('http://localhost:5000/profile').then((response)=>{
      ...
      if(!response.data.message){
        ...
        setFeatured(response.data.featuredImages);
      }
    });
  }, [loggedIn]);
  ...
  return (
    <div className="profile">
      <Link to="/login" style={{ textDecoration: "none" }} onClick={profile}>
        ...
        <ProtectedRoute loggedIn={loggedIn} username={username} image={image} location={location} email={email} photos={photos} featured={featured}/>
    </div>
  )};
